...
sudo apt-get update && sudo apt-get install zsh curl git terminator apt-transport-https build-essential openssl certbot osslsigncode mingw-w64 golang-go chromium
